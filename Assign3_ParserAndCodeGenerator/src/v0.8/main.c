...
int main(int argc, char **argv){
    ...
    if(argc < 2) {
        fn1 = fopen("/Users/Nikeshsrivastava/Desktop/Parser/Parser/input.pl0","rb");
    ...
    if (fo2 == NULL) {
        printf("Error: Output file did not open correctly!\n");
        return 1;
    }
...
void execute(FILE *fo2, instructionData code[], int stack[], regFile *registers) {
